                                    ...
                                    {[0,1,2,3,4,5,6].map(offset => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={cn(
                                                    "flex flex-col items-center justify-center min-w-[70px] h-20 rounded-xl border border-border transition-all",
                                ...
                                <div className="grid grid-cols-4 gap-3">
                                    {["09:00", "10:00", "11:00", "12:00", "13:00", "14:00", "15:00", "16:00"].map(t => (
                                        <button
                                            ...
                                            className={cn(
                                                "py-2 rounded-lg border border-border text-sm hover:bg-accent",
